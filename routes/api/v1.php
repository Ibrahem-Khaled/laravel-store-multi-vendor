...
/*
|--------------------------------------------------------------------------
| API Routes v1 - Legacy Routes (Maintained for Backward Compatibility)
|--------------------------------------------------------------------------
|
| This file contains the original API routes structure.
| These routes are maintained to ensure backward compatibility with existing
| mobile applications and integrations.
|
| IMPORTANT: Do not modify these routes to avoid breaking existing apps
|
| Version: 1.0 (Legacy)
